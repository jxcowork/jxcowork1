...
<tr>
  <td align="center"><table width="758" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	%>
					<%if 0 then%>
                    <tr bgcolor="#FFFFFF">
                      <td colspan="7" align="center"><font color="#FF0000" style="font-size:12px; line-height:18px">－此课程赠送一本《职称英语应试技巧》－</font></td>
                    </tr>
                    <%end if%>
                    <tr bgcolor="#FFFFFF">
                      <td colspan="7" align="center"><font color="#FF0000" style="font-size:12px; line-height:18px">－本期职称英语于考试后三天关闭－</font></td>
...
4.必须有有效成绩，个人因素：如代码漏写，考试作弊等个人因素造成的无效成绩都不能退款或者办理免费重读。</font></TD>
                    </TR>
                    <TR height="20" bgcolor="fafafa">
                      <TD align=middle>课程名称</TD>
                      <TD align=middle>课程内容</TD>
...
2.必须在2013年国家公布分数期间，向我们提供您的查询方式。核实未通过学员姓名与注册一致。<br>
3.孙老师特别提示：全程班的同学如果今年万一没过，请在2013年10月31日前办理免费重读。过期不再办理！<br>
4.必须有有效成绩，个人因素：如代码漏写，考试作弊等个人因素造成的无效成绩都不能退款或者办理免费重读。</TD>
                    </TR>
                    <TR height="20" bgcolor="fafafa">
                      <TD align=middle>课程名称</TD>
                      <TD align=middle>课程内容</TD>
	...
	%>
                    ...
                    <TR>
                      <TD colspan="7" align="center" bgcolor="#f1f2f4"><font style="font-size:14px; line-height:18px"><strong>职称英语高价豪华保过班</strong></font></TD>
                    </TR>
                    <TR>
                      <TD colspan="7" align="left" bgcolor="#ffffff">
<!--H3 align="center"><font color="#0000FF"><strong>“高价豪华保过班”由于时间过短，此课程停止报名</strong></font></H3-->
<H4 align="left" style="; font-size:16px"><font color="#000000">本课程收费<font color="#FF0000"><strong><%=HHZCFee%>元</strong></font>，如果考试不过<font color="#FF0000"><strong>全额退费。</strong></font>孙老师不建议同学报此班，因为本校历年通过率<font color="#FF0000"><strong>极高！</strong></font></font></H4>
<font color="#FF0000">全额退费条件：</font><BR><font color="#000000">1.注册必须用真实姓名注册，必须参加国家考试。<br>2.必须在2013年国家公布分数期间，向我们提供您的查询方式。核实未通过学员姓名与注册一致。<br>
3.孙老师特别提示：全程班的同学如果今年万一没过，请在2013年10月31日前办理退费。过期不再办理！<br>
4.必须有有效成绩，个人因素：如代码漏写，考试作弊等个人因素造成的无效成绩都不能退款。</font></TD>
                    </TR>
                    <TR height="20" bgcolor="fafafa">
                      <TD align=middle>课程名称</TD>
                      <TD align=middle>课程内容</TD>
	...
	%>
                    <tr bgcolor="#FFFFFF">
                      <td colspan="7" align="center"><font color="#FF0000" style="font-size:12px; line-height:18px">－以上均赠送相应课程教材－</font></td>
                    </tr>
                    <tr bgcolor="#FFFFFF">
                      <td colspan="7" align="center"><font color="#FF0000" style="font-size:12px; line-height:18px">－此优惠价<% =SaleEndDate%>前有效（以汇款及转款日期为准）－</font></td>
                    </tr>
